...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::asset('/') }}home/images/logo.ico">
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('/') }}home/css/newindex-09d04b32f3.css"/>
    <script src="{{ URL::asset('/') }}home/js/jquery.js"></script>
    <script src="{{ URL::asset('/') }}home/js/jquery.slider-min.js"></script>
    <script src="{{ URL::asset('/') }}home/js/jquery.dependClass.js"></script>
    <style>
        .gundong{
            line-height: 26px;
            font-size: 18px;
...
<form id="submitform">
    <section class="new-form">
        ...
        <div class="sliderwarp">
            ...
            <div class="maxmoney commoney">{:C('cfg_maxmoney')}元</div>
        ...
        <section class="tiaokuan">
            <div class="cf mt20">
                ...
                <span class="fl arge">同意
                    ...
                    <a class="" id='qbtn4'  href="javascript:;">《平台服务协议》</a>
                </span>
            </div>
        </section>
        <!--申请接借贷-->
        <div class="protit sevagreee ">
            <a class="logBtn" href="javascript:subForm();">立即借款</a>
        </div>
        <!--other-->
        <div class="gundong">
        ...
        <section class="other">
            <a id="dnapp" href="javascript:;">
                <img src="{{ URL::asset('/') }}home/imgs/other.png" alt="">
            </a>
        </section>
        <div class="com" style="text-align: center;">
            <Somnus:block name="首页底部公司名" /><br/><Somnus:sitecfg name="siteicp" />
        </div>
    </section>
    <!-- 底部固定栏 -->
    <!-- bottom bar -->
...
<div class="deowin" style="display: none;padding:0 6%;" id="deowin4">
    <div class="deocon">
        <h3 style="text-align: center;font-size: 16px; color:#fb6f00;height: 40px;line-height: 40px;border-bottom: 1px solid #fb6f00;">《平台服务协议》</h3>
...
<script src="{{ URL::asset('/') }}home/appjs/Index.js"></script>
<div style="display: none;">
